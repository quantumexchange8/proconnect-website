...
<!-- Start of Breadcrumbs  section
	============================================= -->
	<section id="ori-breadcrumbs" class="ori-breadcrumbs-section position-relative" data-background="{{ asset('img/bg/lukas-blazek-mcSDtbWXUZU-unsplash.jpg') }}">
		<div class="container">
				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							<div class="ori-service-icon d-flex justify-content-center align-items-center">
								<img src="{{ asset('img/icon/ic6.png') }}" alt="">
							</div>
							<div class="ori-service-text pera-content">
								<h3>Strategic Media Selection</h3>
								<p>Select platforms that are in line with the campaign's objectives and target audience.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								<h3>Demograohic Targeting</h3>
								<p>Utilize demographic data to target ads more precisely and achieveng better campaign outcomes.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								<h3>Ad Creatives</h3>
								<p>Create powerful and captivating creatives for each platform.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Effectively track campaign results and make real-time strategy adjustments..</p>
							</div>
						</div>
					</div>
				</div>	
