...
<!-- Start of Breadcrumbs  section
	============================================= -->
	<section id="ori-breadcrumbs" class="ori-breadcrumbs-section position-relative" data-background="{{ asset('img/bg/faizur-rehman-pHPzdEHN6Os-unsplash.jpg') }}">
		<div class="container">
					...
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								<h3>Mission and Vision Alignment</h3>
								<p>Ensure digital strategies are in line with the brand's overarching vision and mission.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Identify unique selling points by analyzing competitors.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Placing the brand in a strategic position in the market.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Determine who the intended audience is in order to develop customized tactics.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="700ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Create a well-defined plan for putting digital strategies into action.</p>
							</div>
						</div>
					</div>
				</div>	
