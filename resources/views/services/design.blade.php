				...
				<div class="row justify-content-center">
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Maintain a unified visual identity for all design elements to upload branding consistency.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Prioritize designs that elevates user experiences and usability.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								<h3>Easy Adaptability</h3>
								<p>Create designs solutions that are easily translatable and adapted between various digital platforms.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1000ms">
						<div class="ori-service-item-4">
							...
							<div class="ori-service-text pera-content">
								...
								<p>Create enticing and engaging visual narrative about the brand by utilizing design elements.</p>
							</div>
						</div>
					</div>
				</div>	
